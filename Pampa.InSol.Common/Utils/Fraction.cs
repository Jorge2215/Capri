...
namespace Pampa.InSol.Common.Utils
{
    ...
    {    // These are used to represent the indeterminate with a Denominator of zero
        ...
        public int ToInt32()
        {
            ...
            {
                throw new FractionException(string.Format("Cannot convert {0} to Int32", IndeterminateTypeName(this.numerator)), new System.ArgumentOutOfRangeException());
            }
        ...
        public long ToInt64()
        {
            if (this.denominator == 0)
            {
                throw new FractionException(string.Format("Cannot convert {0} to Int64", IndeterminateTypeName(this.numerator)), new System.ArgumentOutOfRangeException());
            }
